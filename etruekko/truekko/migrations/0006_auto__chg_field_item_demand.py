...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.demand'
        db.alter_column('truekko_item', 'demand', self.gf('django.db.models.fields.CharField')(max_length=3))
    def backwards(self, orm):

        # Changing field 'Item.demand'
        db.alter_column('truekko_item', 'demand', self.gf('django.db.models.fields.BooleanField')())
    models = {
        'auth.group': {
        ...
        'truekko.item': {
            ...
            'demand': ('django.db.models.fields.CharField', [], {'default': "'OFF'", 'max_length': '3'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('truekko_channel', (
        ...
        db.send_create_signal('truekko', ['Channel'])

        # Adding field 'Group.channel'
        db.add_column('truekko_group', 'channel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='groups', to=orm['truekko.Channel']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Channel'
        db.delete_table('truekko_channel')

        # Deleting field 'Group.channel'
        db.delete_column('truekko_group', 'channel_id')

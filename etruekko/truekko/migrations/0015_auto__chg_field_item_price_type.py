...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.price_type'
        db.alter_column('truekko_item', 'price_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    def backwards(self, orm):

        # Changing field 'Item.price_type'
        db.alter_column('truekko_item', 'price_type', self.gf('django.db.models.fields.CharField')(max_length=20))
    models = {
        'auth.group': {

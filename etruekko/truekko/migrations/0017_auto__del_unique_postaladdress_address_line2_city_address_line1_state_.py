...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PostalAddress', fields ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'country']
        db.delete_unique('truekko_postaladdress', ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'country'])

        # Adding unique constraint on 'PostalAddress', fields ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'user', 'country']
        db.create_unique('truekko_postaladdress', ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'user_id', 'country'])

    def backwards(self, orm):
        # Removing unique constraint on 'PostalAddress', fields ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'user', 'country']
        db.delete_unique('truekko_postaladdress', ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'user_id', 'country'])

        # Adding unique constraint on 'PostalAddress', fields ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'country']
        db.create_unique('truekko_postaladdress', ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'country'])

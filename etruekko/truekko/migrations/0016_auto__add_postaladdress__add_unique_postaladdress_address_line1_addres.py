...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('truekko_postaladdress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='postal', to=orm['auth.User'])),
            ...
            ('country', self.gf('etruekko.utils.CountryField')(default='ES', max_length=2)),
        ))
        db.send_create_signal('truekko', ['PostalAddress'])

        # Adding unique constraint on 'PostalAddress', fields ['address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country']
        db.create_unique('truekko_postaladdress', ['address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country'])

    def backwards(self, orm):
        # Removing unique constraint on 'PostalAddress', fields ['address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country']
        db.delete_unique('truekko_postaladdress', ['address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country'])

        # Deleting model 'PostalAddress'
        db.delete_table('truekko_postaladdress')
    ...
    models = {
        ...
        'truekko.postaladdress': {
            'Meta': {'unique_together': "(('address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country'),)", 'object_name': 'PostalAddress'},

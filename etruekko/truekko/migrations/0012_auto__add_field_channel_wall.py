...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.wall'
        db.add_column('truekko_channel', 'wall',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['truekko.Wall'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Channel.wall'
        db.delete_column('truekko_channel', 'wall_id')
    ...
    models = {
        ...
        'truekko.channel': {
            ...
            'wall': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['truekko.Wall']", 'null': 'True', 'blank': 'True'})
        },
        'truekko.commitment': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.premiated_date'
        db.add_column('truekko_userprofile', 'premiated_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.premiated_date'
        db.delete_column('truekko_userprofile', 'premiated_date')

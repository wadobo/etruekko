...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ad'
        db.create_table('truekko_ad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('position', self.gf('django.db.models.fields.CharField')(default='RIGHTTOP', max_length=20)),
            ('type', self.gf('django.db.models.fields.CharField')(default='FIXED', max_length=20)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('html', self.gf('django.db.models.fields.TextField')()),
            ('info', self.gf('django.db.models.fields.TextField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('truekko', ['Ad'])

    def backwards(self, orm):
        # Deleting model 'Ad'
        db.delete_table('truekko_ad')

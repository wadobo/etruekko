...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('truekko_commitment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_commitments', to=orm['auth.User'])),
            ('user_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commitments_to_me', to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='WAI', max_length=3)),
            ('swap', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commitments', to=orm['truekko.Swap'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('truekko', ['Commitment'])

    def backwards(self, orm):
        # Deleting model 'Commitment'
        db.delete_table('truekko_commitment')

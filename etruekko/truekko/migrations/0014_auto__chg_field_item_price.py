...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('truekko_item', 'price', self.gf('django.db.models.fields.IntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'Item.price'
        db.alter_column('truekko_item', 'price', self.gf('django.db.models.fields.IntegerField')(default=0))
    models = {
        'auth.group': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Swap.swap_mode'
        db.add_column('truekko_swap', 'swap_mode',
                      self.gf('django.db.models.fields.CharField')(default='PER', max_length=3),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Swap.swap_mode'
        db.delete_column('truekko_swap', 'swap_mode')
    ...
    models = {
        ...
        'truekko.swap': {
            ...
            'swap_mode': ('django.db.models.fields.CharField', [], {'default': "'PER'", 'max_length': '3'}),

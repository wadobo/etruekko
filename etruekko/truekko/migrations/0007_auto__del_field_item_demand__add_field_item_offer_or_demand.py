...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.demand'
        db.delete_column('truekko_item', 'demand')

        # Adding field 'Item.offer_or_demand'
        db.add_column('truekko_item', 'offer_or_demand',
                      self.gf('django.db.models.fields.CharField')(default='OFF', max_length=3),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Item.demand'
        db.add_column('truekko_item', 'demand',
                      self.gf('django.db.models.fields.CharField')(default='OFF', max_length=3),
                      keep_default=False)

        # Deleting field 'Item.offer_or_demand'
        db.delete_column('truekko_item', 'offer_or_demand')

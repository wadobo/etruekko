...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WallMessage.parent'
        db.add_column('truekko_wallmessage', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='childs', null=True, to=orm['truekko.WallMessage']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'WallMessage.parent'
        db.delete_column('truekko_wallmessage', 'parent_id')

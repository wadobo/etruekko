...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Follow'
        db.create_table('truekko_follow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('follower', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followers', to=orm['auth.User'])),
            ('following', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followings', to=orm['auth.User'])),
        ))
        db.send_create_signal('truekko', ['Follow'])

    def backwards(self, orm):
        # Deleting model 'Follow'
        db.delete_table('truekko_follow')
    ...
    models = {
        ...
        'truekko.follow': {
            ...
            'follower': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'followers'", 'to': "orm['auth.User']"}),
            'following': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'followings'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'truekko.group': {
            'Meta': {'object_name': 'Group'},

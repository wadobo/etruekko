...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transfer.credits'
        db.alter_column('truekko_transfer', 'credits', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Deleting field 'Swap.credits'
        db.delete_column('truekko_swap', 'credits')

        # Adding field 'Swap.credits_from'
        db.add_column('truekko_swap', 'credits_from',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Swap.credits_to'
        db.add_column('truekko_swap', 'credits_to',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Transfer.credits'
        db.alter_column('truekko_transfer', 'credits', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'Swap.credits'
        raise RuntimeError("Cannot reverse this migration. 'Swap.credits' and its values cannot be restored.")
        # Deleting field 'Swap.credits_from'
        db.delete_column('truekko_swap', 'credits_from')

        # Deleting field 'Swap.credits_to'
        db.delete_column('truekko_swap', 'credits_to')
